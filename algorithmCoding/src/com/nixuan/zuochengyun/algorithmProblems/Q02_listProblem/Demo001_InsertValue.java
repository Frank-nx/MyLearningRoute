...
public class Demo001_InsertValue {
    ...
    public static void main(String[] args) {
        ...
        ListNode head = insert(arr,nxt,595);
        ListNode.printCircleList(head);

       /* ListNode root = new ListNode(1);
        root.next = new ListNode(2);
        root.next.next = new ListNode(3);
        root.next.next.next = root;
        ListNode.printCircleList(root);*/
    }

    public static ListNode insert(int[] arr, int[] nxt, int val) {
        // write code here
        if(arr == null){
